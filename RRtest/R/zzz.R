.onAttach <- function(libname, pkgname) {
	...
	# Set packages
	s_requiredpackages = c("plyr", "dplyr","ggplot2","ggfortify","matlib","fitdistrplus","caret","limma","tidyverse","ggsci","showtext","foreach","doParallel","parallel","progress","data.table","splitstackshape") #,"parallel"
